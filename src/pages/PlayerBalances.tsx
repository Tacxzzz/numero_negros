    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <h1 className="text-xl font-bold text-center flex-1">Balances</h1>
              ...
              <Table>
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-center">Wins Balance</TableHead>
                    <TableHead className="text-center">Withdrawable Commissions</TableHead>
                ...
                <TableBody>
                  {filteredBets.map((bet) => (
                    <TableRow key={bet.id}>
                      ...
                      <TableCell className="text-center">{formatPeso(bet.balance)}</TableCell>
                      <TableCell className="text-center">{formatPeso(bet.wins)}</TableCell>
