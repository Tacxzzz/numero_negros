...
import { addLog, getCommissionsTeamTable, getDownlinesTable, getTransactions } from '@/lib/apiCalls';
...
export function PlayerCommissions({onLogout}:SidebarProps) {
  ...
  useEffect(() => {
      if (userID) {
        const handleUpdate = async () => {
          const data = await getCommissionsTeamTable(userID);
          if (data===null) {
          ...
          const addViewLog = await addLog(userID, "visited Referral Commissions");
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <h1 className="text-xl font-bold text-center flex-1">Commissions</h1>
              ...
              <Table>
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-center">Total Accumulated Commissions</TableHead>
                    <TableHead className="text-center">Current Withdrawable Commissions</TableHead>
                ...
                <TableBody>
                  {filteredBets.map((bet) => (
                    <TableRow key={bet.id}>
                      ...
                      <TableCell className="text-center">{formatPeso(bet.total_commission)}</TableCell>
                      <TableCell className="text-center">{formatPeso(bet.commissions)}</TableCell>
