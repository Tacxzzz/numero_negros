              ...
              <Table>
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-center">Total Cashout</TableHead>
                    <TableHead className="text-center">Total Pending Cashout</TableHead>
                    <TableHead className="text-center">Total Successful Cashout</TableHead>
                    <TableHead className="text-center">Total Failed Cashout</TableHead>
                    <TableHead className="text-center">Status</TableHead>
                    <TableHead className="text-center">View Cashouts</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filteredBets.map((bet) => (
                    <TableRow key={bet.id}>
                      ...
                      <TableCell className="text-center">{formatPeso(bet.total_cashout)}</TableCell>
                      ...
                      <TableCell>
                      <Button
                        onClick={() => navigate('/playercashouts', { state: { userID: bet.id } })}
