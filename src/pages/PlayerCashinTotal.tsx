...
import { addLog, getBetsEarnedTeamTable, getDownlinesTable, getTransactions, totalCashinTeamTable } from '@/lib/apiCalls';
...
export function PlayerCashinTotal({onLogout}:SidebarProps) {
  ...
  useEffect(() => {
      if (userID) {
        const handleUpdate = async () => {
          ...
          const addViewLog = await addLog(userID, "visited Referral Total Cashins");
